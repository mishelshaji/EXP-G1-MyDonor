...
namespace MyDonor.Service.Migrations
{
    ...
    [Migration("20230215110631_MyFirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyDonor.Domain.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyDonor.Domain.Models.Customer", b =>
                {
                    b.HasOne("MyDonor.Domain.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Customer")
                        .HasForeignKey("MyDonor.Domain.Models.Customer", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
